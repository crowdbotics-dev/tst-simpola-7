"""
Django settings for tst_simpola_7 project.
...
ROOT_URLCONF = 'tst_simpola_7.urls'
...
WSGI_APPLICATION = 'tst_simpola_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-simpola Support <support@tst-simpola-7.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_simpola_7 API",
    "DESCRIPTION": "API documentation for tst_simpola_7 App",
    "VERSION": "v1",
}
